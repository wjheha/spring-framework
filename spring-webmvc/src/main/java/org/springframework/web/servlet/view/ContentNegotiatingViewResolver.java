 ...
 */
// 实现 ViewResolver、Ordered、InitializingBean 接口，继承 WebApplicationObjectSupport 抽象类，
// 基于内容类型来获取对应 View 的 ViewResolver 实现类，其中，内容类型指的是 "Content-Type" 和拓展后缀
public class ContentNegotiatingViewResolver extends WebApplicationObjectSupport
	...
	// 初始化 contentNegotiationManager 属性
	@Override
